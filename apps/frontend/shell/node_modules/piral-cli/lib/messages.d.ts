 ...
 */
export declare function skipEmulatorUpdate_0120(manifestUrl: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
 ...
 * - [Firefox proxy settings](https://support.mozilla.org/en-US/kb/connection-settings-firefox)
 */
export declare function remoteEmulatorNameChanged_0121(name: string): QuickMessage;
/**
 * @kind Info
 *
 * @summary
 ...
 * - [Firefox proxy settings](https://support.mozilla.org/en-US/kb/connection-settings-firefox)
 */
export declare function optionalEmulatorAssetUpdateSkipped_0122(url: string): QuickMessage;
/**
 * @kind Warning
 *
 * @summary
